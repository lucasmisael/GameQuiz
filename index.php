...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Quiz Iniciação Científica</a>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <hr class="star-light">
        <h2 class="font-weight-light mb-0">Lógica para Programação</h2>
      </div>
    </header>
    ...
    <section class="portfolio" id="game">
          ...
          <div class="col-md-12 col-lg-12">
            <a class="portfolio-item d-block mx-auto" href="#Game_PopUp">
    ...
    <!-- Portfolio Modal 4 -->
    <div class="portfolio-modal mfp-hide" id="Game_PopUp">
      <div class="portfolio-modal-dialog bg-white">
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h2 class="text-secondary text-uppercase mb-0">Quiz Game</h2>
              <hr class="star-dark mb-5">
              <img class="img-fluid mb-5" src="img/portfolio/game.png" alt="">
              <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
              <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="Game.php">
                <i class="fa fa-close"></i>

                <a href="view/Game.php" class="btn btn-primary btn-lg rounded-pill">Ir para o Jogo</a>
